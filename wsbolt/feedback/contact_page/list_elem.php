						...
						<div class="box">
							...
							<div class="box-body table-responsive no-padding">
								<table class="table table-hover table-striped dataTable">
									<tr>
										<th width="30">ID</th>
								        <th style="text-align:center;" class="actioncolumn">Name</th>
								        <th style="text-align:center;" class="actioncolumn">Email</th>
								        <th style="text-align:center;" class="actioncolumn">Phone number</th> 
								        <th style="text-align:center;" class="actioncolumn">Message</th>          
								        ...
								        <tr class="<?if($Elem['active']==0){?>disabled<?}?>">
								            ...
								            <td align="center" width="210">
												<div class="btn-group wgroup">
							                		...
							                		<a href="edit_elem.php?id=<?=$Elem['id']?>" class="btn btn-default">
