...
<head>
    ...
    <link rel="stylesheet" href="/<?=WS_PANEL?>/templates/lte/plugins/select2/select2.min.css">
    <script src="/<?=WS_PANEL?>/templates/lte/plugins/select2/select2.min.js"></script>
